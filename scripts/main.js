;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKE LANDSCAPE MODE', 'HEY AYAA', 'COBA LIAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI WLEE', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAU KAMU PASTI KESAL', 'TAPI INI BENER ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YAUDAH DEH', 'I', 'LOVE', 'YOU ♡', 'HAPPY VALENTINE DAY', 'HEHEHE', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU SEDIKIT KESAL', 'MAAFIN AKU JUGA', 'DI HARI VALENTINE PERTAMA KITA', 'AKU MALAH GA SAMA KAMU DI JOGJA', 'TAPI', 'AKU MAU BILANG', 'KALO AKU SAYANG BANGET', 'SAMA KAMU AYAA', 'ANDRA SAYANG AYAA', 'HEHEHE', 'BUBAII CANTIKNYA ANDRA', 'JANGAN LUPA NYOBLOS PRABOWO WLEE']
